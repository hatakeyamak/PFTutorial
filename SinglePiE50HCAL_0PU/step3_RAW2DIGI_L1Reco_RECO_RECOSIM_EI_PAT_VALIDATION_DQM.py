...
process.source = cms.Source("PoolSource",
    ...
    'root://kodiak-se.baylor.edu//store/user/hatake/PFTutorial/2019/inputFiles/step2_SinglePiE50HCAL_0PU_2018.root'),
...
process.RECOSIMoutput.outputCommands.append('keep recoPFRecHits_particleFlow*_*_*')
process.RECOSIMoutput.outputCommands.append('keep recoPFClusters_particleFlowClusterHBHE_*_*')
process.RECOSIMoutput.outputCommands.append('keep *_*pfTrack*_*_*')
