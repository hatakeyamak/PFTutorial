...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://kodiak-se.baylor.edu//store/user/hatake/PFTutorial/2019/inputFiles/step2_SinglePiPt25Eta3p0_4p0_2026D41.root'),
...
process.FEVTDEBUGHLToutput.outputCommands.append('keep recoPFRecHits_particleFlow*_*_*')
process.FEVTDEBUGHLToutput.outputCommands.append('keep *_*pfTrack*_*_*')
process.MINIAODSIMoutput.outputCommands.append('keep recoPFRecHits_particleFlow*_*_*')
process.MINIAODSIMoutput.outputCommands.append('keep *_*pfTrack*_*_*')
